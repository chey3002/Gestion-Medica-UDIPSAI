...
public class EspecialistaDao {
    ...
    public int modificar(Especialista especialista) {
        try {
            ...
            ps.setString(9, String.valueOf(especialista.isEstaActivo()));
            ps.setString(10, especialista.getCedula());
    ...
    public List<Especialista> listar() {
        ...
        try {
            ...
            while (data.next() == true) {
                ...
                especialista.setEstaActivo(data.getBoolean(10));
    ...
    public Especialista verificarCredenciales(String cedula, String contraseña) {
        try {
            ...
            if (resultSet.next()) {
                ...
                especialista.setPrimerNombre(resultSet.getString("primerNombre"));
                especialista.setPrimerApellido(resultSet.getString("primerApellido"));
     ...
     public boolean existeEspecialistaResponsable(String cedula) {
        try {
            String query = "SELECT COUNT(*) FROM especialista WHERE cedula = ?";
            Connection connection = this.conexion.getConnection();
            PreparedStatement statement = connection.prepareStatement(query);
            statement.setString(1, cedula);
            ResultSet resultSet = statement.executeQuery();
